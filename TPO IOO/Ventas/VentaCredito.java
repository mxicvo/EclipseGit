...
public class VentaCredito extends Venta {
    ...
    private LocalDate fechaVtoTarjeta;
    private int codSeguridadTarjeta;
    private static float comision;

    public VentaCredito(String tipoDeTarjeta, int numeroTarjeta, LocalDate fechaVtoTarjeta, int codSeguridadTarjeta) {
		super();
	...
	public LocalDate getFechaVtoTarjeta() {
		return fechaVtoTarjeta;
	}

	public void setFechaVtoTarjeta(LocalDate fechaVtoTarjeta) {
		this.fechaVtoTarjeta = fechaVtoTarjeta;
	}
