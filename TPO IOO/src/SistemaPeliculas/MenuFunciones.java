...
public class MenuFunciones extends JFrame {
	...
	public MenuFunciones() {
		...
		JButton btnNewButton = new JButton("Alta Funcion");
		...
		JButton btnNewButton_1 = new JButton("Modificar Funcion");
		btnNewButton_1.setBounds(150, 118, 137, 23);
		contentPane.add(btnNewButton_1);
		
		JButton btnNewButton_2 = new JButton("Baja Funcion");
